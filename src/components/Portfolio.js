...
const Portfolio = () => {
  const projects = [
    ...
    },
    {
      ...
      image: sorting,
      live: 'https://sorting-visualizer-ybmlk.netlify.app/',
      github: 'https://github.com/ybmlk/sorting-visualizer',
      description: `
      Web application built with React for visualizing 
      sorting algorithms. Implements Merge Sort, Quick Sort, Heap Sort, 
